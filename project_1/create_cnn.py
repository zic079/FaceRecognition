...
x = Conv2D(filters=6, kernel_size=(5, 5), strides=1, activation='sigmoid')(inputs)
x = MaxPooling2D(pool_size=(2, 2), strides=2)(x)
x = Conv2D(filters=16, kernel_size=(5, 5), strides=1, activation='sigmoid')(x)
x = MaxPooling2D(pool_size=(2, 2), strides=2)(x)
x = Conv2D(filters=120, kernel_size=(5, 5), strides=1, activation='sigmoid')(x)
